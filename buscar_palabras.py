...
def buscar_palabras(texto):
    ...
    palabras_clave = ['anular', 'sustituir limitador', 'sustituir maniobra', 'casquillo', 'encasquillar', 'anulado',
...
''''anular','substituir limitador','substituir manobra','casquilho','encasquilhar','não atua','atuaria',
